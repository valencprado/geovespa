    ...
    async forgotPassword(ctx) {
        ...
        const emailToSend = {
            ...
            from: resetPasswordSettings.from.email || resetPasswordSettings.from.name ?
                `${resetPasswordSettings.from.name} <${resetPasswordSettings.from.email}>` : undefined,
        ...
        await strapi.microaitec.plugins('services').service('forgetUser').execute({ user, resetPasswordToken })
